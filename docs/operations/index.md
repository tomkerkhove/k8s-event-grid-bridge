---
layout: default
title: Operating Kubernetes Event Bridge
---

Here is an overview of how you can operate Kubernetes Event Bridge. 

# Health
Kubernetes Event Bridge provides a basic health endpoint that indicates the state of the scraper.
